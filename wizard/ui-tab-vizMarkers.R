                 ...
                 tabsetPanel(id = "vm", type = "tabs",
                             ...
                             tabPanel("Expression Heatmap",
                                      column(12,
                                             ...
                                             h3(strong("Expression Heatmap:")),
                                             column(3,
                                                    wellPanel(
                                                      
                                                      numericInput("numGenesPerCluster2", "# top genes to show per cluster (min:1, max:10)", value = 10, min = 1, max = 10)
                                             ...
                                             column(9,
                                                    column(12,
                                                           plotOutput("ExpressionHeatmap", height="1000px")
                                                    )
                                             )
                                      ))
                 )
